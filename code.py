...
# ====== CONFIG PAGE ======
st.set_page_config(
    page_title="Login - Data Integration Platform",
    page_icon="🔐",
    layout="centered",
    initial_sidebar_state="collapsed"
)

# ====== LOGIN CREDENTIALS (Dalam produksi, gunakan database atau file terenkripsi) ======
VALID_USERS = {
    "admin": "admin123",
    "rifandi": "0000129", 
    "yaticuy": "3710239",
...
def show_login_page():
    ...
    st.markdown("""
    <style>
    /* Background gradient - White with green accent */
    .stApp {
        background: linear-gradient(#ffffff, #ffffff 0%, #ffffff 50%, #ffffff 100%);
        min-height: 100vh;
    ...
    .app-title {
        ...
        color: #61C9A8;
        margin: 0;
        text-shadow: 0 2px 4px rgba(97, 201, 168, 0.2);
    }
    ...
    .stTextInput > div > div > input:focus {
        border-color: #61C9A8;
        box-shadow: 0 0 0 3px rgba(97, 201, 168, 0.1);
        background: white;
    }
    ...
    .stButton > button {
        width: 100%;
        background: linear-gradient(135deg, #61C9A8, #4fd1c7);
        color: white;
        border: none;
        border-radius: 12px;
    ...
    <div class="logo-container">
        ...
        <h1 class="app-title">Data Integration Platform</h1>
        <p class="app-subtitle">Solusi Enterprise untuk Integrasi & Analisis Data</p>
    </div>
    """, unsafe_allow_html=True)
...
#            login_button = st.form_submit_button("🚀 Login", use_container_width=True)
    ...
    if login_button:
        if username and password:
            if username in VALID_USERS and VALID_USERS[username] == password:
                ...
                with st.empty():
                    st.markdown("""
                    <div class="login-alert" style="background: linear-gradient(135deg, #ecfdf5, #d1fae5); color: #047857; border: 1px solid #61C9A8;">
                        ✅ Login berhasil! Mengalihkan ke aplikasi...
                    </div>
                    """, unsafe_allow_html=True)
                    time.sleep(1.5)
                    st.rerun()
                ...
                if st.session_state.login_attempts >= 3:
                    ...
                    <div class="login-alert alert-error">
                        🚫 Terlalu banyak percobaan login gagal. Silakan tunggu sebentar.
                    </div>
                    """, unsafe_allow_html=True)
                    time.sleep(2)
                else:
            ...
            <div class="login-alert alert-warning">
                ⚠️ Mohon isi username dan password.
            </div>
            """, unsafe_allow_html=True)
    ...
    <div class="login-footer">
        🔒 Sistem Keamanan Aktif | v1.0<br>
        Hubungi <strong>+62 878 8103 3781</strong> untuk bantuan teknis<br>
        <small style="color: #61C9A8;">Powered by Data Integration Platform</small>
    </div>
    """, unsafe_allow_html=True)
    
    st.markdown('</div>', unsafe_allow_html=True)

# ====== MAIN APPLICATION (Kode aplikasi utama Anda) ======
def show_main_app():
    # Reset page config untuk aplikasi utama
    st.set_page_config(
    ...
    <div class="running-banner">
        <span>🚀 Aplikasi Ini Bertujuan Untuk Mengolah Data Agar Lebih Cepat & Mudah! 📊</span>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="custom-header">
        ...
        <p>Solusi Enterprise untuk Integrasi, Analisis, & Visualisasi Data Excel</p>
    </div>
    """, unsafe_allow_html=True)
